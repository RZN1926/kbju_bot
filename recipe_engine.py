...
_SYSTEM_PROMPT = textwrap.dedent("""
    ...
    7. ВАЖНО: Все числовые значения (вес, калории и т. д.) ДОЛЖНЫ быть целыми числами или числами с плавающей запятой. НЕ используйте математические выражения, такие как «2 * 50». Всегда указывайте окончательное расчетное число.
